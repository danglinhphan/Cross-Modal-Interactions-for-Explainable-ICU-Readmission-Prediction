...
This implementation is based on a tested reference and returns aggregated SHAP
factors mapped back to the original input feature names (where possible).
"""
...
def predict(req: PredictRequest):
    ...
    if req.explain:
        ...
        shap_info = None
        try:
            # If model uses a sklearn Pipeline with a 'preprocessor' and 'clf' steps,
            # compute shap on preprocessed features and aggregate them back to base inputs.
